        ...
        function() {
            ...
            if (0 !== u.length)
                for (var p, e = 0; e < u.length; e++) ! function(c) {
                    ...
                    if (e && "" !== e) {
                        var a = JSON.parse(e),
                            r = a.mapLayer || "https://api.maptiler.com/maps/voyager/{z}/{x}/{y}.webp?key=5vRQzd34MMsINEyeKPIs",
                            n = a.coordinates || [0, 0],
                            o = a.zoom || 1,
                        ...
                        if (L.tileLayer(r, {
                            ...
                            for (p = 0; p < i.length; p++) {
                                var l = i[p].iconUrl,
                                    s = i[p].className,
                                    l = L.icon({
                                        iconUrl: l || "img/map/marker-icon.webp",
                                        iconSize: [25, 39],
                                        iconAnchor: [12, 39],
                                        shadowUrl: "img/map/marker-shadow.webp",
                                        shadowSize: [41, 41],
                                        shadowAnchor: [13, 41],
                                        popupAnchor: [1, -28],
                                        className: s
                        ...
                        var t = e.mapLayer || "https://api.maptiler.com/maps/voyager/{z}/{x}/{y}.webp?key=5vRQzd34MMsINEyeKPIs",
                            a = e.coordinates || [0, 0],
                            r = e.zoom || 1,
                    ...
                    }) : (d = L.map(u[c]).setView([0, 0], 1), L.tileLayer("https://api.maptiler.com/maps/voyager/{z}/{x}/{y}.webp?key=5vRQzd34MMsINEyeKPIs", {
                        tileSize: 512,
                        zoomOffset: -1,
                        minZoom: 1,
                        attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
