...
// تابع کمکی برای نمایش مودال نوتیفیکیشن
...
// تابع کمکی برای نمایش مودال تایید
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bg-dark border-light">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <p class="text-light mb-0" id="confirmModalMessage" style="font-size: 1rem; line-height: 1.6;">
...
document.addEventListener('DOMContentLoaded', function() {
                ...
                <div class="d-flex justify-content-between align-items-center p-3 rounded-2 bg-faded-dark">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                        <div class="file-icon-small">
                            <i class="${getFileIcon(selectedRevisionFile.name)}"></i>
                        </div>
                    ...
                    <button type="button" class="btn btn-sm btn-link text-danger p-0 remove-revision-file-btn">
                        <i class="fi-x"></i>
                    </button>
                </div>
            `;
    ...
    if (revisionForm) {
        revisionForm.addEventListener('submit', async function(e) {
            ...
            if (selectedRevisionFile) {
                formData.append('revision_file', selectedRevisionFile);
            }
...
// ========== نمودار کلیک‌های روزانه به تفکیک کانال (استایل حرفه‌ای) ==========
const clicksCanvas = document.getElementById('dailyClicksByChannelChart');
if (clicksCanvas) {
    ...
    if (labels.length > 0 && datasets.length > 0) {
        ...
        if (hasNonZero) {
            // بهبود datasets با استایل مشابه نمودار هزینه
            const enhancedDatasets = datasets.map(ds => ({
                ...ds,
                borderWidth: 2,
                backgroundColor: ds.borderColor + '1A',   // 10% opacity برای fill
            ...
            new Chart(ctx, {
                ...
                options: {
                    responsive: true,
                    maintainAspectRatio: false,   // مهم برای تنظیم دستی ارتفاع
                    plugins: {
                        legend: {
                            labels: {
                                color: '#fff',
                    ...
                    scales: {
                        ...
                        x: {
                            ...
                            ticks: {
                                ...
                                maxRotation: 45,
                                minRotation: 45,
                                font: { size: 10, family: 'IRANSans, Vazir' }
                            }
                        }
                    },
                    interaction: {
