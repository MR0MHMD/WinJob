from campaigns.models import CampaignInfluencer, CampaignInvoice, Campaign
    ...
    def get_context_data(self, **kwargs):
        ...
        for channel in pending_channels_list:
            pending_actions.append({
                ...
                'subtitle': f'اینفلوئنسر: {channel.influencer.full_name}',
        ...
        for report in pending_reports:
            pending_actions.append({
                ...
                'subtitle': f'اینفلوئنسر: {report.campaign_influencer.channel.influencer.full_name}',
                'icon': 'fi-file-clean',
                'color': '#fdbc31',
